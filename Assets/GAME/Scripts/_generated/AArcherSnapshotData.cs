...
public struct AArcherSnapshotData : ISnapshotData<AArcherSnapshotData>
{
    public uint tick;
    ...
    public void Serialize(int networkId, ref AArcherSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
        ...
        changeMask0 |= (Child2RotationValueX != baseline.Child2RotationValueX ||
                                           ...
                                           Child2RotationValueW != baseline.Child2RotationValueW) ? (1u<<10) : 0;
        changeMask0 |= (Child2TranslationValueX != baseline.Child2TranslationValueX ||
                                           ...
                                           Child2TranslationValueZ != baseline.Child2TranslationValueZ) ? (1u<<11) : 0;
        changeMask0 |= (Child3RotationValueX != baseline.Child3RotationValueX ||
                                           ...
                                           Child3RotationValueW != baseline.Child3RotationValueW) ? (1u<<12) : 0;
        changeMask0 |= (Child3TranslationValueX != baseline.Child3TranslationValueX ||
                                           ...
                                           Child3TranslationValueZ != baseline.Child3TranslationValueZ) ? (1u<<13) : 0;
    ...
    public void Deserialize(uint tick, ref AArcherSnapshotData baseline, ref DataStreamReader reader,
