...
public struct ACivilianGhostSerializer : IGhostSerializer<ACivilianSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<ACivilianSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref ACivilianSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
