...
public struct A_BarracksGhostSerializer : IGhostSerializer<A_BarracksSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<A_BarracksSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref A_BarracksSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
