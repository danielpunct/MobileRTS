...
public class A_BarracksGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<A_BarracksSnapshotData> ghostSnapshotDataType;
...
#endif
                A_BarracksSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<A_BarracksSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<A_BarracksSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<A_BarracksSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<A_BarracksSnapshotData>(true),
...
public partial class A_BarracksGhostSpawnSystem : DefaultGhostSpawnSystem<A_BarracksSnapshotData>
{
}
