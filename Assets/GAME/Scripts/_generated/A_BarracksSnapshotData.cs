...
public struct A_BarracksSnapshotData : ISnapshotData<A_BarracksSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref A_BarracksSnapshotData baseline1, ref A_BarracksSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref A_BarracksSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref A_BarracksSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref A_BarracksSnapshotData target, float factor)
    {
