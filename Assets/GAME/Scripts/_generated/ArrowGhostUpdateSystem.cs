...
public class ArrowGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#pragma warning restore 649
#endif
        [ReadOnly] public ArchetypeChunkBufferType<ArrowSnapshotData> ghostSnapshotDataType;
        [ReadOnly] public ArchetypeChunkEntityType ghostEntityType;
        public ArchetypeChunkComponentType<PlayerBullet> ghostPlayerBulletType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            var ghostPlayerBulletArray = chunk.GetNativeArray(ghostPlayerBulletType);
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
...
#endif
                ArrowSnapshotData snapshotData;
                snapshot.GetDataAtTick(targetTick, targetTickFraction, out snapshotData);

                var ghostPlayerBullet = ghostPlayerBulletArray[entityIndex];
                ...
                ghostPlayerBullet.PlayerId = snapshotData.GetPlayerBulletPlayerId(deserializerState);
                ...
                ghostPlayerBulletArray[entityIndex] = ghostPlayerBullet;
            }
        }
    }
    [BurstCompile]
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<ArrowSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
                ComponentType.ReadWrite<PlayerBullet>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<ArrowSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<ArrowSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<ArrowSnapshotData>(true),
                ...
                ghostPlayerBulletType = GetArchetypeChunkComponentType<PlayerBullet>(),
...
public partial class ArrowGhostSpawnSystem : DefaultGhostSpawnSystem<ArrowSnapshotData>
{
}
