...
public struct ArrowSnapshotData : ISnapshotData<ArrowSnapshotData>
{
    public uint tick;
    private int PlayerBulletPlayerId;
    ...
    public int GetPlayerBulletPlayerId(GhostDeserializerState deserializerState)
    {
        return (int)PlayerBulletPlayerId;
    }
    public int GetPlayerBulletPlayerId()
    {
        return (int)PlayerBulletPlayerId;
    }
    public void SetPlayerBulletPlayerId(int val, GhostSerializerState serializerState)
    {
        PlayerBulletPlayerId = (int)val;
    }
    public void SetPlayerBulletPlayerId(int val)
    {
        PlayerBulletPlayerId = (int)val;
    }
    ...
    public void PredictDelta(uint tick, ref ArrowSnapshotData baseline1, ref ArrowSnapshotData baseline2)
    {
        var predictor = new GhostDeltaPredictor(tick, this.tick, baseline1.tick, baseline2.tick);
        PlayerBulletPlayerId = predictor.PredictInt(PlayerBulletPlayerId, baseline1.PlayerBulletPlayerId, baseline2.PlayerBulletPlayerId);
    ...
    public void Interpolate(ref ArrowSnapshotData target, float factor)
    {
