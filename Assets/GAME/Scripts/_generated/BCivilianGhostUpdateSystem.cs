...
public class BCivilianGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<BCivilianSnapshotData> ghostSnapshotDataType;
...
#endif
                BCivilianSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<BCivilianSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<BCivilianSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<BCivilianSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<BCivilianSnapshotData>(true),
...
public partial class BCivilianGhostSpawnSystem : DefaultGhostSpawnSystem<BCivilianSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        [ReadOnly] public NativeArray<BCivilianSnapshotData> snapshots;
    ...
    protected override JobHandle SetPredictedGhostDefaults(NativeArray<BCivilianSnapshotData> snapshots, NativeArray<int> predictionMask, JobHandle inputDeps)
    {
