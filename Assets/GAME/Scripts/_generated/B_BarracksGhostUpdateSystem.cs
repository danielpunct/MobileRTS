...
public class B_BarracksGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<B_BarracksSnapshotData> ghostSnapshotDataType;
...
#endif
                B_BarracksSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<B_BarracksSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<B_BarracksSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<B_BarracksSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<B_BarracksSnapshotData>(true),
...
public partial class B_BarracksGhostSpawnSystem : DefaultGhostSpawnSystem<B_BarracksSnapshotData>
{
}
