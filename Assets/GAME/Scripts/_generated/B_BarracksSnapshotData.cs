...
public struct B_BarracksSnapshotData : ISnapshotData<B_BarracksSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref B_BarracksSnapshotData baseline1, ref B_BarracksSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref B_BarracksSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref B_BarracksSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref B_BarracksSnapshotData target, float factor)
    {
