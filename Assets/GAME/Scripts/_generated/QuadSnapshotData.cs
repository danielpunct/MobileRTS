...
public struct QuadSnapshotData : ISnapshotData<QuadSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref QuadSnapshotData baseline1, ref QuadSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref QuadSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref QuadSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref QuadSnapshotData target, float factor)
    {
