...
public struct _UnitGhostSerializer : IGhostSerializer<_UnitSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<_UnitSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref _UnitSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
